    ...
    public function handle()
    {
        ...
        if($this->confirm('Do you wish to continue?'))
        {
            ...
            foreach(Stock::lists('stock_code') as $key => $stockCode){
                if(!Historicals::where(['stock_code' => $stockCode, 'date' => '2016-08-25'])->first()){
                    $historicalSheetUrl = "http://real-chart.finance.yahoo.com/table.csv?s=".$stockCode.".AX&a=03&b=21&c=2016&d=07&e=25&f=2016&g=d&ignore=.csv";
