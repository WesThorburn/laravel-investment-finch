<div class="pull-right half-margin-top hidden-xs">
	{!! Form::open(['action' => 'StockController@show', 'method' => 'get', 'class' => 'form-group form-inline no-margin-bottom', 'id' => 'searchForm']) !!}
...
<span class="default-margin-bottom default-margin-top visible-xs">
	{!! Form::open(['action' => 'StockController@show', 'method' => 'get', 'class' => 'form-group form-inline', 'id' => 'searchForm']) !!}
