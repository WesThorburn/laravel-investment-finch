						    ...
						    <tbody data-link="row" class="rowlink panel-body">
							    @foreach($flaggedStocks as $stock)
									<tr>
										...
										<td>
										<a href="/dashboard/addToBillionCapList/{{ $stock->stock_code }}" class="btn btn-default btn-row glyphicon glyphicon-plus center-block" title="Add to Billion Cap List"></a>
										</td>
									</tr>
								@endforeach
						    </tbody>
